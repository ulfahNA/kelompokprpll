...
public class validasi extends javax.swing.JFrame {
    ...
    public validasi() {
        ...
        String[] judul = {"Id_Peserta","Nama_Peserta","Validasi"};
    ...
    private void baca_idpeserta(){
        try{
            ...
            sql = "select * from seminar where Id_Peserta = '" + jTextField1.getText() + "'";
            rs = stat.executeQuery(sql);
            if(rs.next()){
                jTextField2.setText(rs.getString("Nama_Peserta"));
                jComboBox1.setSelectedItem(rs.getString("Validasi"));
                tampilkan();
            } else {
                jTextField2.setText("");
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Validasi Kehadiran");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        try {
            ...
            rs.execute("update seminar set Nama_Peserta='"+jTextField2.getText()+"',Validasi='"+jComboBox1.getSelectedItem()+"' where Id_Peserta='"+jTextField1.getText()+"'");   
         tampilkan();
            jTextField1.setText("");
            jTextField2.setText("");
    ...
    private void tampilkan() {
        ...
        for(int i=0; i<jum; i++){
            tabel.removeRow(0);}       
    try {
        Connection con  = DriverManager.getConnection("jdbc:mysql://localhost:3306/seminar","root","091010412");
        ResultSet data = con.createStatement().executeQuery("SELECT Id_Peserta,Nama_Peserta, Validasi FROM seminar");
        while(data.next()){
        String[] dat = {data.getString("Id_Peserta"),data.getString("Nama_Peserta"),data.getString("Validasi")};
        tabel.addRow(dat);}
    } catch (SQLException ex) {
      System.out.println("Terjadi Kesalahan Pada ..!"+ex);
    }
